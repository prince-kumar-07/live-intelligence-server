...
// API key lives in .env (YOUTUBE_API_KEY). Free tier: 10,000 quota
// units/day; search.list costs 100 units/call, so ~100 searches/day before
// Google starts returning 429 "quota exceeded" — at that point every
// lookup fails and the UI shows "No Live Feeds Available" even though
// live streams may well exist.
